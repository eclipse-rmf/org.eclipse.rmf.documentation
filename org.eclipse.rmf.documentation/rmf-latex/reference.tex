...
Information can be entered either directly into the cell by double clicking it or by opening the properties window by right clicking any of the cells in the row. All of the SpecObjects information will then be available for editing in the Properties Editor.
