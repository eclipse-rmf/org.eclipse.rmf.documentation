...
Search will take place across line breaks.  But this is only relevant for Regexp search, where linebreaks can be matched explicitly (\menu{\textbackslash n}) or as part of whitespace (\menu{\textbackslash s}).
\end{info}
