...
INF-1 has two \term{Attributes}, ``Description'' and ``ID''.  The \term{SpecType} is ``Information Type'' (shown as the header in the properties view).
...
Last, there are seven \term{DatatypeDefinitions}, some of which can be customized further.
